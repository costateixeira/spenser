...
```json
{
  ...
  "definition" : {
    ...
    },
    {
      ...
      {
        "url" : "http://hl7.org/fhir/StructureDefinition/implementationguide-page",
        "valueUri" : "MedicationDispense-DispenseForActionableDarkOrder.html"
      }],
      "reference" : {
        "reference" : "MedicationDispense/DispenseForActionableDarkOrder"
      },
      "name" : "Example - Dispense reported back",
    ...
    },
    {
      ...
      {
        "url" : "http://hl7.org/fhir/StructureDefinition/implementationguide-page",
        "valueUri" : "MedicationDispense-DeclinedDispenseOutOfStock.html"
      }],
      "reference" : {
        "reference" : "MedicationDispense/DeclinedDispenseOutOfStock"
      },
      "name" : "Example - Dispense that did not happen",
    ...
    },
    {
      ...
      {
        "url" : "http://hl7.org/fhir/StructureDefinition/implementationguide-page",
        "valueUri" : "MedicationRequest-ActionableDarkOrder.html"
      }],
      "reference" : {
        "reference" : "MedicationRequest/ActionableDarkOrder"
      },
      "name" : "Example - Order made actionable by a tag",
    ...
    },
    {
      ...
      {
        "url" : "http://hl7.org/fhir/StructureDefinition/implementationguide-page",
        "valueUri" : "MedicationRequest-PlainMilkOrder.html"
      }],
      "reference" : {
        "reference" : "MedicationRequest/PlainMilkOrder"
      },
      "name" : "Example - Order that is not actionable on its own",
    ...
    },
    {
      ...
      {
        "url" : "http://hl7.org/fhir/StructureDefinition/implementationguide-page",
        "valueUri" : "Task-FulfillPlainMilkOrder.html"
      }],
      "reference" : {
        "reference" : "Task/FulfillPlainMilkOrder"
      },
      "name" : "Example - Task asking for an order to be fulfilled",
