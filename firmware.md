# Firmware - Spenser - a developer's companion v1.0.0
...
1. Connect to a USB port. On Windows, use Microsoft drivers -**DO NOT use other drivers like CH340 etc.**
1. From the`firmware`folder, run PlatformIo to compile, upload and monitor
1. **Please help improve the code - PRs are more than welcome.**
