...
| Active as of 2026-09-20 | *Computable Name*:SpenserRequest |

**Usages:**

* Examples for this Profile: [MedicationRequest/ActionableDarkOrder](MedicationRequest-ActionableDarkOrder.md), [MedicationRequest/PlainMilkOrder](MedicationRequest-PlainMilkOrder.md) and [MedicationRequest/med-request-1234](MedicationRequest-med-request-1234.md)
...
```json
{
  ...
  "name" : "SpenserRequest",
  "status" : "active",
  "date" : "2026-09-20T09:14:24+00:00",
  "publisher" : "Zeora",
  "contact" : [{
    "name" : "Zeora",
    "telecom" : [{
